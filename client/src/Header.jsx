...
const Header = () =>{
  const {user} = useContext(UserContext);
    return(
        ...
        <Link to={'/'} className='flex items-center gap-1'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 -rotate-90">
        ...
        <Link to={(user)?'/account':'/login'} className='flex border items-center gap-2 border-gray-300 rounded-full py-2 px-4  shadow-gray-300'>
