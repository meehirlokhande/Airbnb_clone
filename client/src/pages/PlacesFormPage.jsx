    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                {preInput('Check in&out times, max guests', 'add check in and out times, remember to have some time window for cleaning the room bwtween guests.')}
                <div className="grid grid-col-2 gap-2 md:grid-cols-4">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" value={maxGuests} onChange={ev => setMaxGuests(ev.target.value)} placeholder="10" />
                    </div>

                    <div>
                        <h3 className="mt-2 -mb-1">Price per night</h3>
                        <input type="number" value={price} onChange={ev => setPrice(ev.target.value)} placeholder="10" />
                    </div>

                    <button className="bg-primary my-4 w-full rounded-xl text-white p-1">Save</button>
